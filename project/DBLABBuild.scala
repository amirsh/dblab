...
//     .settings(sharedSettings).nativeSettings(resolvers += Resolver.sonatypeRepo("snapshots"))

//   lazy val dblab_components_native = dblab_components.native
//   lazy val dblab_components_jvm = dblab_components.jvm
