...
object TPCHInterpreter extends TPCHRunner {
  ...
  def executeQuery(query: String, schema: Schema): Unit = query match {
    ...
    // case "Q12_p2"            => Q12_p2(Config.numRuns)
    ...
    case "Q9_functional_p2"  => Q9_functional_p2(Config.numRuns)
    case "Q10_functional"    => Q10_functional(Config.numRuns)
    case "Q11_functional"    => Q11_functional(Config.numRuns)
    ...
    case "Q20_functional"    => Q20_functional(Config.numRuns)
