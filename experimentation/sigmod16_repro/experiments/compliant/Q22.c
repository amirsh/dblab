...
int main(int argc, char** argv) {
  ...
  size_t x4743 = x4741->st_size;
  int x4744 = PROT_READ;
  int x4745 = MAP_PRIVATE;
  char* x3 = mmap(NULL, x4743, x4744, x4745, x4737, 0);
  /* VAR */ int x4 = 0;
  while(1) {
  ...
  size_t x4883 = x4881->st_size;
  int x4884 = PROT_READ;
  int x4885 = MAP_PRIVATE;
  char* x61 = mmap(NULL, x4883, x4884, x4885, x4878, 0);
  /* VAR */ int x62 = 0;
  while(1) {
    ...
    x61 = x4926;
    int x4928 = x4914*(10000);
    int x4929 = x4919*(100);
    int x4930 = x4928+(x4929);
    int x4931 = x4930+(x4924);
    ...
    x6573->O_ORDERKEY = x4894; x6573->O_CUSTKEY = x4899; x6573->O_ORDERSTATUS = x4907; x6573->O_TOTALPRICE = x4909; x6573->O_ORDERDATE = x4931; x6573->O_ORDERPRIORITY = x5986; x6573->O_CLERK = x6004; x6573->O_SHIPPRIORITY = x4971; x6573->O_COMMENT = x6027;
    int x97 = x62;
  ...
  for(; x104 < 1 ; x104 += 1) {
    ...
    void*** x36752 = (void***){x36745};
    int* x36753 = (int*){x36748};
    GHashTable* x36754 = g_hash_table_new(x36752, x36753);
    ...
    double x36926 = x36924/(x36925);
    *(x36923 + 2) = x36926;
    x36768 = x36756;
    struct AGGRecord_String* x36929 = x36768;
    double* x36930 = x36929->aggs;
    double x36931 = x36930[2];
    /* VAR */ int x36932 = 0;
    /* VAR */ int x36933 = 0;
    int* x36976 = &(x36955);
    ...
    while(1) {
      ...
      /* VAR */ int ite20913 = 0;
      if(x19457) {
        double x37108 = x326->C_ACCTBAL;
        int x37109 = x37108>(x36931);
        ite20913 = x37109;
      } else {
      ...
      if(x19459) {
        ...
        GList* x7314 = *(x7313);
        GList* x7315 = g_list_prepend(x7314, x7305);
        pointer_assign(x7313, x7315);
        void* x7317 = (void*){x7313};
        g_hash_table_insert(x36754, x7304, x7317);
      };
      int x1874 = x36932;
      int x350 = x1874+(1);
      x36932 = x350;
    ...
    while(1) {
      ...
      int x37140 = x36933;
      int x37141 = x37140<(x4871);
      if (!(x37141)) break; 
      
      int x1883 = x36933;
      struct ORDERSRecord* x359 = &(x5929[x1883]);
      int x361 = x359->O_CUSTKEY;
      void* x7329 = (void*){x361};
      void* x7330 = g_hash_table_lookup(x36754, x7329);
      GList** x7331 = (GList**){x7330};
      int x12201 = x7331!=(NULL);
      if(x12201) {
        GList* x8556 = *(x7331);
        ...
        while(1) {
          ...
          GList* x8559 = x8557;
          GList* x8560 = NULL;
          int x8561 = x8559!=(x8560);
          if (!(x8561)) break; 
          
          GList* x8562 = x8557;
          void* x8563 = g_list_nth_data(x8562, 0);
          struct CUSTOMERRecord* x8564 = (struct CUSTOMERRecord*){x8563};
          int x8565 = x8564->C_CUSTKEY;
          int x8566 = x8565==(x361);
          int x8567 = !(x8566);
          if(x8567) {
            GList* x8568 = x8557;
            GList* x8569 = x8568->next;
            GList** x8570 = &(x8569);
            x8558 = x8570;
          } else {
    ...
    for(; x16933 < x37261 ; x16933 += 1) {
      ...
      while(1) {
        ...
        *(x15329 + x15331) = '\0';
        ...
        double x8704 = x8688->C_ACCTBAL;
        double x8705 = x8704+(x8703);
        *x8702 = x8705;
        double x8707 = x8702[1];
        double x8708 = x8707+(1.0);
        *(x8702 + 1) = x8708;
      };
    };
...
int x8746(void* x8740, void* x8741, void* x8742) {
  struct AGGRecord_OptimalString** x8743 = (struct AGGRecord_OptimalString**){x8742};
  struct AGGRecord_OptimalString* x8744 = (struct AGGRecord_OptimalString*){x8741};
  pointer_assign(x8743, x8744);
  return 1; 
}
